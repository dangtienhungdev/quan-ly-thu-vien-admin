...
import type { GradeLevel, UpdateGradeLevelRequest } from '@/types/grade-levels';
...
type UpdateGradeLevelFormData = z.infer<typeof updateGradeLevelSchema>;

interface EditGradeLevelFormProps {
	gradeLevel: GradeLevel;
	onSubmit: (data: UpdateGradeLevelRequest) => void;
	onCancel: () => void;
	isLoading?: boolean;
}

const EditGradeLevelForm = ({
	gradeLevel,
	onSubmit,
	onCancel,
	isLoading = false,
}: EditGradeLevelFormProps) => {
	const form = useForm<UpdateGradeLevelFormData>({
	...
	const handleSubmit = (data: UpdateGradeLevelFormData) => {
		onSubmit({
			...data,
